...
vcfanno -permissive-overlap ./AllDataBases/conf_ClinVar.toml  ./1-ClinVar/clinvar_Data_Annotate.vcf > ./1-ClinVar/Annotat_$1
egrep -v "^#" ./1-ClinVar/Annotat_$1 > ./1-ClinVar/Annotat_$1_noHeader.vcf
python3 ./1-ClinVar/CV_NewData.py $1
...
bedtools intersect -wb -wa -f 1.0 -r -a ./AllDataBases/GWAS_DB.vcf  -b $1 > ./2-Gwas/gwas_Data_$1
python3 ./2-Gwas/GW_NewData.py $1 

# 3- PharmGKP Work
# Find the intersect with PharmGKP  Database, and Run Python of the input file for PG
bedtools intersect -wb -wa -f 1.0 -r -a ./AllDataBases/Pharm_DB.vcf -b  $1 > ./3-PharmGKP/PhG_$1
python3 ./3-PharmGKP/PharmWork.py $1

# 4- Dida Work
# Find the intersect with Dida  Database, and Run Python of the input file for Di
bedtools intersect -wa -wb -f 1.00 -r -a ./AllDataBases/DIDA_DB.vcf -b  $1 > ./4-Dida/Di_$1
python3 ./4-Dida/DI_NewData.py $1
