...
do
  ./VSIM/Simulation/rtg-tools/rtg childsim --mother $moth --father $fath  -i ./Simulation/Parent_$1_$2.vcf.gz  -o ./Simulation/CreatedChildren/$1_$2_children/child$c.vcf.gz -t ./Simulation/1000g_v37_phase2.sdf -s child$c
done
...
bedtools intersect -wa -wb -f 1.00 -r -a ./AllDataBases/CV_DB.vcf -b ./Simulation/CreatedChildren/$1_$2_children/*.vcf.gz  -filenames > ./1-ClinVar/CV_$1_$2
python ./1-ClinVar/CV_Children.py $1_$2 $child

# GWAS
bedtools intersect -wb -wa -f 0.50 -r -a ./AllDataBases/GWAS_DB.vcf -b ./Simulation/CreatedChildren/$1_$2_children/*.vcf.gz  -filenames  > ./2-Gwas/GW_$1_$2
python ./2-Gwas/Gwas_children.py $1_$2 $child

# PharmGKP
bedtools intersect -wb -wa  -a  ./AllDataBases/Pharm_DB.vcf -b ./Simulation/CreatedChildren/$1_$2_children/*.vcf.gz  -filenames > ./3-PharmGKP/PhG_$1_$2
python ./3-PharmGKP/Pharm_Children.py $1_$2 $child

# Dida
bedtools intersect -wa -wb  -a ./AllDataBases/DIDA_DB.vcf -b ./Simulation/CreatedChildren/$1_$2_children/*.vcf.gz  -filenames > ./4-Dida/Di_$1_$2
